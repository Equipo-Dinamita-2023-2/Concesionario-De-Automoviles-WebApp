...
=======
# Generated by Django 4.2.5 on 2023-11-29 17:11
>>>>>>> CDAW-108-BD
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RepuestosOrdenes',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_reparacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ordenreparacion')),
                ('id_repuesto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.repuesto')),
            ],
        ),
        migrations.AddField(
            model_name='repuesto',
            name='id_tipo_vehiculo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.tipovehiculo'),
        ),
        migrations.AddField(
